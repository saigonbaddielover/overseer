...
| Command | Effect |
|---|---|
| `list [--all]` | List agent panes + their **HARNESS** (claude/codex) + **PEER**, the harness name a claude session is addressable by (`-` when it has none). `--all`: every pane + its foreground command. |
